...
SECRET_KEY = 'django-insecure-lheer3)gq^8h&v+-rchzc9l9dlzi#nz6!!c2^(s=dos2c&aoxm'
...
INSTALLED_APPS = [
    ...
    'products',
    'django_extensions', 
    'users.apps.UsersConfig',  # Keep this one
    'cart',
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "oumab071@gmail.com"
EMAIL_HOST_PASSWORD = "simplybrian1"  # Use an app password instead of your actual password
